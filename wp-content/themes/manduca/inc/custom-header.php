...
add_action( 'after_setup_theme', 'manduca_custom_header_setup' );


function manduca_header_style() {
...
function manduca_admin_header_style() {
?>
...
function manduca_admin_header_image() {
	?>
	<div id="headimg">
		<?php
		if ( ! display_header_text() ) {
