	...
	<div class="row">
		...
		?>
			<div class="hero-unit box effect2">
				...
				<p>
					<a href="<?php the_permalink(); ?>" class="btn btn-primary btn-large"><?php echo __( 'Read more', 'biscayalite' );?></a>
				</p>
			</div>
		<?php
			endwhile;
							...
							<div class="inneritem">
								...
								<header class="entry-header sectiontitlepost">
									...
									<div class="entry-meta">
										...
										<div class="text-right"><i class="fa fa-comment"></i>&nbsp;  <?php comments_popup_link( __( 'Add Comment', 'biscayalite' ), __( '1 Comment', 'biscayalite' ), __( '% Comments', 'biscayalite' ), __( 'Comments off', 'biscayalite' ) ); ?></div>
									</div><!-- .entry-meta -->
